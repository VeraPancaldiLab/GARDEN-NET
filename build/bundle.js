...
"use strict";
eval("\nObject.defineProperty(exports, \"__esModule\", { value: true });\nconst React = __webpack_require__(/*! react */ \"react\");\nconst react_router_dom_1 = __webpack_require__(/*! react-router-dom */ \"react-router-dom\");\nconst reactstrap_1 = __webpack_require__(/*! reactstrap */ \"reactstrap\");\nclass PortalMenu extends React.Component {\n    constructor(props) {\n        super(props);\n        this.toggle_organism = () => {\n            this.setState({\n                dropdownOpen_organism: !this.state.dropdownOpen_organism,\n            });\n        };\n        this.toggle_cell_type = () => {\n            this.setState({\n                dropdownOpen_cell_type: !this.state.dropdownOpen_cell_type,\n            });\n        };\n        this.onClick = (event) => {\n            const target = event.target;\n            const value = target.value;\n            this.setState({ organism: value });\n        };\n        this.state = {\n            dropdownOpen_organism: false,\n            dropdownOpen_cell_type: false,\n            organism: \"Choose\",\n        };\n    }\n    render() {\n        const organisms = [\"Homo sapiens\", \"Mus musculus\"];\n        const cell_types = {\n            Choose: [\"\"],\n            Homo: [\"aCD4\", \"EP\", \"Ery\", \"FoeT\", \"Mac0\", \"Mac1\", \"Mac2\", \"MK\", \"Mon\", \"naCD4\", \"nB\", \"nCD4\", \"nCD8\", \"Neu\", \"tB\", \"tCD4\", \"tCD8\"],\n            Mus: [\"Embryonic stem cells\"],\n        };\n        const organism_key = this.state.organism.split(\" \")[0];\n        return (React.createElement(\"div\", { className: \"container text-center\" },\n            React.createElement(\"div\", { className: \"row\" },\n                React.createElement(\"div\", { className: \"col\" }, \"Organism\"),\n                React.createElement(\"div\", { className: \"col\" }, \"Cell Type\")),\n            React.createElement(\"div\", { className: \"row\" },\n                React.createElement(\"div\", { className: \"col\" },\n                    React.createElement(reactstrap_1.ButtonDropdown, { style: { display: \"grid\" }, isOpen: this.state.dropdownOpen_organism, toggle: this.toggle_organism },\n                        React.createElement(reactstrap_1.DropdownToggle, { caret: true }, this.state.organism),\n                        React.createElement(reactstrap_1.DropdownMenu, { className: \"text-center container-fluid\", style: { height: \"auto\", maxHeight: \"200px\", overflowX: \"hidden\" } },\n                            organisms.slice(0, -1).map((organism) => React.createElement(\"div\", { key: organism },\n                                React.createElement(reactstrap_1.DropdownItem, { value: organism, onClick: this.onClick, className: \"organism\" }, organism),\n                                React.createElement(reactstrap_1.DropdownItem, { style: { margin: 0 }, divider: true }))),\n                            organisms.slice(-1).map((organism) => React.createElement(reactstrap_1.DropdownItem, { key: organism, value: organism, onClick: this.onClick, className: \"organism\" }, organism))))),\n                React.createElement(\"div\", { className: \"col\" },\n                    React.createElement(reactstrap_1.ButtonDropdown, { style: { display: \"grid\" }, isOpen: this.state.dropdownOpen_cell_type, toggle: this.toggle_cell_type },\n                        React.createElement(reactstrap_1.DropdownToggle, { disabled: this.state.organism == \"Choose\", caret: true }, this.state.organism == \"Choose\" ? \"Choose an organism first\" : \"Choose\"),\n                        React.createElement(reactstrap_1.DropdownMenu, { className: \"text-center container-fluid\", style: { height: \"auto\", maxHeight: \"200px\", overflowX: \"hidden\" } },\n                            cell_types[organism_key].slice(0, -1).map((cell_type) => React.createElement(\"div\", { key: cell_type },\n                                React.createElement(react_router_dom_1.Link, { target: \"_blank\", to: \"/Visualize/\" + this.state.organism.split(\" \").join('_') + \"/\" + cell_type.split(\" \").join(\"_\"), key: cell_type }, cell_type),\n                                React.createElement(reactstrap_1.DropdownItem, { style: { margin: 0 }, divider: true }))),\n                            cell_types[organism_key].slice(-1).map((cell_type) => React.createElement(react_router_dom_1.Link, { target: \"_blank\", to: \"/Visualize/\" + this.state.organism.split(\" \").join('_') + \"/\" + cell_type.split(\" \").join(\"_\"), key: cell_type }, cell_type))))))));\n    }\n}\nexports.PortalMenu = PortalMenu;\n\n\n//# sourceURL=webpack:///./src/components/PortalMenu.tsx?");
