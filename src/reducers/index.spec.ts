import {
  ...
  CHANGED_FEATURES_METADATA,
  CHANGED_FEATURES_NEW,
  CHANGED_ORGANISM,
  CHANGED_SEARCH,
  CHANGED_TEXT
} from "../actions/index";
...
describe("reducers", () => {
  describe("chromosomes_reducer", () => {
    it("should provide the initial state", () => {
      expect(Reducer.chromosomes_reducer(undefined, {})).toBe(
        Reducer.DEFAULT_CHROMOSOME
      );
    });
    ...
    it("should ignore unknown actions", () => {
      ...
      ).toBe(Reducer.DEFAULT_CHROMOSOME);
    });
  });

  describe("features_reducer", () => {
    it("should provide the initial state", () => {
      expect(Reducer.features_reducer(undefined, {})).toBe(
        Reducer.DEFAULT_FEATURE
      );
    });
    ...
    it("should ignore unknown actions", () => {
      expect(
        Reducer.features_reducer(Reducer.DEFAULT_FEATURE, { type: "unknown" })
      ).toBe(Reducer.DEFAULT_FEATURE);
    });
  });

  describe("features_list_reducer", () => {
    it("should provide the initial state", () => {
      expect(Reducer.features_list_reducer(undefined, {})).toBe(
        Reducer.DEFAULT_FEATURES_LIST
      );
    });
    ...
    it("should ignore unknown actions", () => {
      ...
      ).toBe(Reducer.DEFAULT_FEATURES_LIST);
    });
  });

  describe("features_metadata_reducer", () => {
    it("should provide the initial state", () => {
      expect(Reducer.features_metadata_reducer(undefined, {})).toBe(
        Reducer.DEFAULT_FEATURES_METADATA
      );
    });
    ...
    it("should ignore unknown actions", () => {
      ...
      ).toBe(Reducer.DEFAULT_FEATURES_METADATA);
    });
  });

  describe("features_new_reducer", () => {
    it("should provide the initial state", () => {
      expect(Reducer.features_new_reducer(undefined, {})).toBe(
        Reducer.DEFAULT_FEATURES_NEW
      );
    });
    ...
    it("should ignore unknown actions", () => {
      ...
      ).toBe(Reducer.DEFAULT_FEATURES_NEW);
    });
  });

  describe("search_reducer", () => {
    it("should provide the initial state", () => {
      expect(Reducer.search_reducer(undefined, {})).toBe(
        Reducer.DEFAULT_SEARCH
      );
    });
    ...
    it("should ignore unknown actions", () => {
      expect(
        Reducer.search_reducer(Reducer.DEFAULT_SEARCH, { type: "unknown" })
      ).toBe(Reducer.DEFAULT_SEARCH);
    });
  });
  ...
  describe("text_reducer", () => {
    ...
    it("should ignore unknown actions", () => {
      expect(
        Reducer.text_reducer(Reducer.DEFAULT_TEXT, { type: "unknown" })
      ).toBe(Reducer.DEFAULT_TEXT);
    });
  });

  describe("organism_reducer", () => {
    it("should provide the initial state", () => {
      expect(Reducer.organism_reducer(undefined, {})).toBe(
        Reducer.DEFAULT_ORGANISM
      );
    });
    ...
    it("should ignore unknown actions", () => {
      expect(
        Reducer.organism_reducer(Reducer.DEFAULT_ORGANISM, { type: "unknown" })
      ).toBe(Reducer.DEFAULT_ORGANISM);
    });
  });

  describe("cell_type_reducer", () => {
    it("should provide the initial state", () => {
      expect(Reducer.cell_type_reducer(undefined, {})).toBe(
        Reducer.DEFAULT_CELL_TYPE
      );
    });
    ...
    it("should ignore unknown actions", () => {
      ...
      ).toBe(Reducer.DEFAULT_CELL_TYPE);
    });
  });
});
